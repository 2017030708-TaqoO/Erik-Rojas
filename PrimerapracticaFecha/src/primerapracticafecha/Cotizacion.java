 ...
 */
    ...
    public int pagoInicial(int precioa)
    {
        int imp=25,precioPI;
        precioPI=precioa*imp/100;
        return precioPI;       
    }
    
    public int totalAFin (int precioa,int precioPI)
    {
       int totalAFin;
       totalAFin=precioa-precioPI;
       return totalAFin;
    }
    
    public int pagoMensual(int totalAFin, int imp)
    {
        int pagoM;
        pagoM=totalAFin/imp;
        return pagoM;
