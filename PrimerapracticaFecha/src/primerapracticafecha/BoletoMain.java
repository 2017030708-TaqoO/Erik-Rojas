...
public class BoletoMain {
    ...
    public static void main(String[] args) {
        ...
        int numBoleto=0, numCliente=0, precio=0,op=0;
        String destino="", tipoDeViaje="",fecha="";
        ...
        switch(op)
         {
            ...
            case 3:
                ...
                edad = in.nextInt();
                System.out.println("Digite el tipo de viaje /n1=normal 2=doble");
                tdv = in.nextInt();
                precio = hoy.descuento(edad, tdv);
